...
namespace CrashKonijn.Goap.Resolver
{
    ...
    public struct GraphResolverJob : IJob
    {
        ...
        private void AddConnections(
            RunData runData, ref NativeParallelHashMap<int, NodeData> openSet,
            ref NativeParallelHashMap<int, NodeData> closedSet, NodeData currentNode
        )
        {
        ...
        private void RetracePath(NodeData startNode, NativeParallelHashMap<int, NodeData> closedSet, NativeList<NodeData> path)
        {
